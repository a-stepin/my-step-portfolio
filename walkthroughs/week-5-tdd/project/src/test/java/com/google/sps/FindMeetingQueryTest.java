...
public final class FindMeetingQueryTest {
  ...
  @Test
  public void everyAttendeeIsConsideredWithOptionalAllDayAttendee() {
    ...
    Collection<Event> events = Arrays.asList(
        ...
        new Event("Event 2", TimeRange.fromStartDuration(TIME_0900AM, DURATION_30_MINUTES),
            Arrays.asList(PERSON_B)),
        new Event("Event 3", TimeRange.fromStartEnd(TIME_START, TIME_END, true),
  ...
  @Test
  public void everyAttendeeIsConsideredWithOptionalEarlyAttendee() {
    // Have each person have different events and an optional attendee with an all-day event.
    // We should see two options because each person has split the restricted times.
    //
    // Events  :       |--A--|     |--B--|
  ...
  @Test
  public void everyAttendeeIsConsideredOnlyOptionalAttendees() {
    // Have each person have different events. We should see two options because each person has
    // split the restricted times.
    //
    // Events  :       |--A--|     |--B--|
